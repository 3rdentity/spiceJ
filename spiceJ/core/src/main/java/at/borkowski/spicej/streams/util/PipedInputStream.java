 ...
 *   The only modification (expect for package names and a note in the JavaDoc is the introduction
...
/**
 * <b>NOTE: This JavaDoc is taken from the Oracle JDK7 source, which
 * makes certain links in this JavaDoc wrongly point to the Oracle
 * JDK classes. Therefore, do not follow links from this code without
 * checking whether the correct class has been referenced.</b>
 * 
